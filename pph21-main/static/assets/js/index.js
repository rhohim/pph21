...
function loadTable() {
  $(document).ready(function () {
    ...
    $.fn.dataTable.ext.errMode = function ( settings, helpPage, message ) { 
      // alert("Error")
      localStorage.clear("datacsv")
      document.getElementById('alert').classList.remove('hidealert')
  };
    $("#example").DataTable({
      "bDestroy": true,
      data: dataPph,
...
// const final = localStorage.getItem("datacsv")
// const stockData = (JSON.parse(final))
// console.log(stockData)

const stockData = dataPph
