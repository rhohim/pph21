...
print("Netto_Bulan ", Netto_Bulan)
print("Netto_Tahun ", Netto_Tahun)
print("PTKP ", PTKP)
print("PKP ", PKP)
print("Tarif_Pajak ", Tarif_Pajak)
print("PPH21_Tahun ", PPH21_Tahun)
...
while Gaji_Bersih != mark_gaji and mark != Tunj_Pajak:
    ...
    # print(Tunj_Pajak," ",PPH21_Bulan," ", mark)
    #get Gaji_Bersih
    Gaji_Bersih =  Total_Gaji - PPH21_Bulan
    # print(Gaji_Bersih)
print("GrossUP")
